...
nav_order: 5
permalink: /en/android/settings/
---

# Settings and App Use

The Settings and Help areas in WellNest let you adjust reminders, contact the research team, view support resources, and upload data manually if needed.
...
> Important: Changing reminder time does not change the survey availability window. The Morning Survey and Evening Survey buttons are still available only during their scheduled time windows.

## Contacting us through Help screen

The **Help screen** contains the research team's contact email address. You are welcome to contact the team at any time with questions or concerns.

Email: [study-support@mcl.iis.u-tokyo.ac.jp](mailto:study-support@mcl.iis.u-tokyo.ac.jp)
...
Under normal conditions, WellNest automatically uploads sensor and survey data in the background.
...
## Keeping the app running in the background {#keeping-the-app-running-in-the-background}

Throughout the study, WellNest must keep running in the background so it can collect sensor data.
...
Make sure the **App Close Warning** notification category is enabled in [Notification settings]({{ '/en/android/permissions/#notification-settings' | relative_url }}).
...
When the 12-week formal data collection period ends, the research team will let you know by email and through an in-app message.

After the team has reviewed and processed your data, they will contact you as soon as possible about compensation arrangements.

## Next
{: .next-step-heading }

If something is not working as expected, see [Troubleshooting]({{ '/en/android/troubleshooting/' | relative_url }}).
{: .next-step }
