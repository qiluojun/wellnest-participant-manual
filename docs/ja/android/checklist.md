...
nav_order: 7
permalink: /ja/android/checklist/
---

# クイックチェックリスト

時間がない場合や、設定と研究期間中の作業が順調に進んでいるか確認したい場合に、このチェックリストをご利用ください。

## 開始前

- [ ] **WellNest** と **WellNest Health** の両方をインストールした。[アプリをインストールする]({{ '/ja/android/setup/' | relative_url }})を参照してください。
- [ ] すべての権限を許可した。[権限を許可する]({{ '/ja/android/permissions/' | relative_url }})を参照してください。
- [ ] 赤い感嘆符が消えていることを確認した。[権限設定が完了したか確認する方法]({{ '/ja/android/permissions/#how-to-confirm-permissions-are-complete' | relative_url }})を参照してください。
- [ ] 通知を許可した。[通知設定]({{ '/ja/android/permissions/#notification-settings' | relative_url }})を参照してください。
- [ ] 事前アンケートに回答した。[事前アンケート]({{ '/ja/android/surveys/#pre-study-survey' | relative_url }})を参照してください。
- [ ] WellNest がバックグラウンドで起動していることを確認した。[アプリをバックグラウンドで起動状態に保つ]({{ '/ja/android/settings/#keeping-the-app-running-in-the-background' | relative_url }})を参照してください。
- [ ] 権限設定が完了した後にのみ WellNest Health をアンインストールした。[WellNest Health はいつアンインストールできますか？]({{ '/ja/android/permissions/#when-can-i-uninstall-wellnest-health' | relative_url }})を参照してください。
